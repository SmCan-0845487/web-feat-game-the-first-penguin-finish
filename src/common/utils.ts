import { Animation, Color3, CubicEase, EasingFunction, QuarticEase, Vector3 } from '@babylonjs/core';
...
export function createAnimation(
  target: any, property: string, to: number | Vector3 | Color3, option?: CreateAnimationOption
) {
  const {
 ...
 */
export function getSquareMatrixPositions(gap: number, length: number, origin = new Vector3(0, 0, 0)) {
